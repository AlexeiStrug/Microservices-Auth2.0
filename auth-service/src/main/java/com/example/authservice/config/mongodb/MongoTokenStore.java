package com.example.authservice.config.mongodb;

import com.example.authservice.domain.MongoAccessToken;
import com.example.authservice.domain.MongoRefreshToken;
